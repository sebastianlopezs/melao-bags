...
const Registro = () => {
    ...
    <>
    <VscArrowLeft
    className="cursor-pointer text-black text-2xl hover:text-red-600 transition duration-300 my-3 mx-3"
    onClick={()=> {
        navigate("/");
    }}
    />
...
<div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
    <a href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
        <img className="w-8 h-8 mr-2" src="../../public/melaologo.jpg" alt="logo" />   
      </a>
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                  ...
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                      ¿Ya es miembro? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Inicie sesión aquí</a>
                  </p>
              </form>
          </div>
      </div>
